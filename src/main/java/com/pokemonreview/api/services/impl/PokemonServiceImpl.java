...
public class PokemonServiceImpl implements PokemonService {
    ...
    @Override
    public PokemonResponse getAllPokemon(Integer pageNo, Integer pageSize) {
        Pageable pageable = (Pageable) PageRequest.of(pageNo, pageSize);
        Page<Pokemon> pokemon;
        pokemon = pokemonRepository.findAll(pageable);
        List<Pokemon> listOfPokemon = pokemon.getContent();
//        map used because it creates a new list
        ...
        pokemonResponse.setTotalElements((int) pokemon.getTotalElements());
